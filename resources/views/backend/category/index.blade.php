            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                        <img src="{{ asset('images/'.$category->photo) }}" class="img-fluid zoom" style="max-width:80px" alt="{{$category->photo}}">
                        @else
                    ...
                    <td>
                        <a href="{{ route('category.edit', ['id' => $category->id]) }}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
