        ...
        <div class="form-group">
          ...
          <select name="country" id="cat_id" class="form-control">
              ...
              @foreach($markets as $market)
                  <option value='{{$market->id}}'>{{$market->country->name}}</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
          <label for="cat_id">MarketPlace <span class="text-danger">*</span></label>
          <select name="market" id="cat_id" class="form-control">
