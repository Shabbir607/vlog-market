    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/shipping.create">Add Shipping</a>
          </div>
        </div>
    </li>
...
<!-- marketplaces -->
    ...
    <li class="nav-item">
      ...
      <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('/post')}}">Posts</a>
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Category Options:</h6>
            <a class="collapse-item" href="{{ route('/post-category')}}">Category</a>
    ...
    <li class="nav-item">
        ...
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="{{ route('/post-tag')}}">Tag</a>
     ...
     <!--Orders -->
   <li class="nav-item">
        <a class="nav-link" href="{{route('/jobapply')}}">
            <i class="fas fa-hammer fa-chart-area"></i>
