...
@section('main-content')
    ...
    <!-- End Breadcrumbs -->
    <a href="{{route('jobs.apply',$post->slug)}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Apply</a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="content">
                                    ...
                                    <h3>JobType:</h3>
                                    <p style="max-height: 3.6em; overflow: hidden; text-overflow: ellipsis;">{!! html_entity_decode($post->type) !!}</p>
                                    
                                    <h3>Location:</h3>
                                    <p style="max-height: 3.6em; overflow: hidden; text-overflow: ellipsis;">{!! html_entity_decode($post->location) !!}</p>
                                    
                                    <h3>Salary:</h3>
                                    <p style="max-height: 3.6em; overflow: hidden; text-overflow: ellipsis;">{!! html_entity_decode($post->salary) !!}</p>
        
                                </div>
                                <div>
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget search">
                            <form class="form" method="GET" action="{{route('jobs.search')}}">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Jobs Categories</h3>
