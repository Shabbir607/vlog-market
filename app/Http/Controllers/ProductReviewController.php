...
class ProductReviewController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($review) {
            ...
            request()->session()->flash('error', 'Review not found'); // Handle the case where the review is not found
        }
    
        return redirect()->route('/review'); // Assuming 'review.index' is your route for listing reviews
    }
